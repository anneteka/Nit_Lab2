...
async function fetchAsync() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".menu-link").on('click', function () {
...
async function fillCategories() {
    let body = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#category");
    ...
    body.html(answer);
    jquery__WEBPACK_IMPORTED_MODULE_2___default()("#basket-b").on('click', async function () {
        let body2 = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#spa-holder");
        let body = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#spa-holder-100");
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(".minus-holder").on('click', function () {
            let span = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#amount-" + event.target.id.substring(6));
            ...
            if (parseInt(span.html()) === 0) {
                jquery__WEBPACK_IMPORTED_MODULE_2___default()("#basket-" + event.target.id.substring(6)).css('display', 'none');
                basketCounter--;
            }
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(".plus-holder").on('click', function () {

            let span = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#amount-" + event.target.id.substring(5));
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2___default()(".delete").on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#basket-" + event.target.id.substring(7)).css('display', 'none');
            basketProducts[event.target.id.substring(7)] = 0;
            basketCounter--;
            if (basketCounter===0)
                body.html("<div class='empty-div'><span class='empty'>Ваш кошик пустий.</span></div>")
        });
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('#contact-form').submit(function () {
            formCheckout();
            return false;
        });
    });
...
function formCheckout() {
    ...
    body2.css("display", "none");
    body.css("display", "block");
    let name = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#name").val();
    let number = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#phone").val();
    let email = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#email").val();
...
function clearBasketSuccess(){
    jquery__WEBPACK_IMPORTED_MODULE_2___default()("#spa-holder-100").html("<div class='empty-div'><span class='empty'>Замовлення успішно оформлене</span></div>");
    for (let i =0; i<basketProducts.length; i++)
    {
        basketProducts[i]=0;
    }
...
async function showProduct(id, category) {
    ...
    body.html(write);
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".buy").on('click', function () {
        buyProduct(event.target.id);
    });

    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".button-back").on('click', function () {
...
async function showCategory(category) {
    ...
    let body = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#spa-holder");
    let body2 = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#spa-holder-100");
    body2.css("display", "none");
    body.css("display", "block");
    ...
    body.html(write);
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".product-holder").on('click', function () {
        showProduct(event.target.id, category).then(data => console.log("product load"));
    });
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(".product-holder-button").on('click', function () {
        buyProduct(event.target.id);
    });
}
